...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/12/05 22:01:29 by knaumov           #+#    #+#             */
/*   Updated: 2018/12/05 22:03:00 by knaumov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_strstr(line, "p1") && ft_strstr(line, "knaumov"))
	{
		filler->player = 'O';
		filler->enemy = 'X';
	}
	else if (ft_strstr(line, "p2") && ft_strstr(line, "knaumov"))
	{
		filler->player = 'X';
		filler->enemy = 'O';
	}
